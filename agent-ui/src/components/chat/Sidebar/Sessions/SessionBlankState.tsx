    ...
    const errorMessage = (() => {
        switch (true) {
            case !isEndpointActive:
                return 'Endpoint не подключён. Подключитесь к endpoint для просмотра истории.'
            case !selectedEndpoint:
                return 'Выберите endpoint для просмотра истории.'
            case !agentId:
                return 'Выберите агента для просмотра истории.'
            default:
                return 'Сессий пока нет. Начните диалог, чтобы создать одну.'
        }
    })()
        ...
        <div className="mt-1 flex items-center justify-center rounded-lg bg-background-secondary/50 pb-6 pt-4">
            <div className="flex flex-col items-center gap-1">
                ...
                <div className="flex flex-col items-center gap-2">
                    <h3 className="text-sm font-medium text-primary">Сессии не найдены</h3>
